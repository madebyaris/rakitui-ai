 ...
 */
function detectCSSFramework(html: string): string[] {
 ...
 */
function extractStyles(html: string): { css: string; cleanHtml: string } {
 ...
 */
function wrapInIsolatedContainer(html: string, index: number, frameworks: string[]): string {
 ...
 */
function safeEncodeForJS(html: string): string {
 ...
 */
function generateDecodeFunction(): string {
  return `
 ...
 */
function generateFrameworkCSS(frameworks: string[]): string {
  let css = '';
 ...
 */
function analyzeComponentLayout(html: string): 'gallery' | 'card' {
  const lowerHtml = html.toLowerCase();
 ...
 */
function generateLayoutCSS(layouts: ('gallery' | 'card')[]): string {
...
export function generateDesignSelectionHTML(input: DesignInput): string {
  ...
  const requiredFields: (keyof DesignInput)[] = ['design_name_1', 'design_html_1', 'design_name_2', 'design_html_2', 'design_name_3', 'design_html_3'];
